<?php
    ...
    if( isset( $_POST["BoutonConfirmerMdp"] ) )
    {
        ...
        $resultatSELECT = $connexionMySQLi->query( "SELECT * FROM utilisateur WHERE ( mot_de_passe='$motDePasse' AND ( type_utilisateur IN ( 'admin' , 'comptable' ) ) )" ) or die( $connexionMySQLi->error );
