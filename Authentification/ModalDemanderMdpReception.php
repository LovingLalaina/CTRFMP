...
<div id="ModalDemanderMdpReception" class="modal fade">
	<div class="modal-Dialog modal-dialog modal-confirm">
		<div class="modal-Content modal-content">
			...
			<form name="FormulaireLoginReception" method="POST" action="../Authentification/donnerDroitReception.php">
				<div class="modal-body">
					<p class="text-center" style="color:rgb(37, 37, 37);">Faites vous parti de la section réception?</p><br/>
					<div class="row">
						...
						<div class="col-md-1" style="position:relative;top:10px;right:10px;"><i id="AfficherMdpReception" class="fas fa-eye-slash text-purple"></i></div>
					</div>
				</div>
...
<script src="../Modeles/dynamiserMdpReception.js" ></script>